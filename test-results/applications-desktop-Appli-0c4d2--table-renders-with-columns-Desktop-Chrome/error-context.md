...
- Name: applications-desktop.spec.ts >> Applications list — Desktop (TC-APP-DESK) >> TC-APP-DESK-01 table renders with columns
- Location: e2e/applications-desktop.spec.ts:11:3
