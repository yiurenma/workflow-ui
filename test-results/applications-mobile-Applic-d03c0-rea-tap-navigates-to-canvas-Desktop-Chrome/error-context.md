...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-04 card info area tap navigates to canvas
- Location: e2e/applications-mobile.spec.ts:42:3
