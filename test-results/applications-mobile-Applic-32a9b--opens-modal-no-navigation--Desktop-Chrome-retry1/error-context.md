...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-06 ellipsis menu → Copy opens modal (no navigation)
- Location: e2e/applications-mobile.spec.ts:75:3
