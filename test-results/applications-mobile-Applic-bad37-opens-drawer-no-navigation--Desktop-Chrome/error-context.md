...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-05 ellipsis menu → History opens drawer (no navigation)
- Location: e2e/applications-mobile.spec.ts:55:3
