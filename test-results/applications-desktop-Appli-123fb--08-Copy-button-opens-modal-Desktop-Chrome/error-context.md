...
- Name: applications-desktop.spec.ts >> Applications list — Desktop (TC-APP-DESK) >> TC-APP-DESK-08 Copy button opens modal
- Location: e2e/applications-desktop.spec.ts:73:3
