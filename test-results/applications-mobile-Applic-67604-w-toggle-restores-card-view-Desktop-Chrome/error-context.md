...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-03 Mobile view toggle restores card view
- Location: e2e/applications-mobile.spec.ts:28:3
