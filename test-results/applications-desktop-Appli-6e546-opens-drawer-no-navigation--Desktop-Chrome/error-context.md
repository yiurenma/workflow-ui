...
- Name: applications-desktop.spec.ts >> Applications list — Desktop (TC-APP-DESK) >> TC-APP-DESK-07 History button opens drawer (no navigation)
- Location: e2e/applications-desktop.spec.ts:61:3
