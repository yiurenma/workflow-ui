...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-01 card view renders (not table) on narrow viewport
- Location: e2e/applications-mobile.spec.ts:10:3
