...
- Name: applications-desktop.spec.ts >> Applications list — Desktop (TC-APP-DESK) >> TC-APP-DESK-02 pagination visible below table
- Location: e2e/applications-desktop.spec.ts:17:3
