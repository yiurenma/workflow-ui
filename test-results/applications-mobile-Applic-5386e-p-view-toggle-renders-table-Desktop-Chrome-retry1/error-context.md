...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-02 Desktop view toggle renders table
- Location: e2e/applications-mobile.spec.ts:18:3
