...
- Name: applications-desktop.spec.ts >> Applications list — Desktop (TC-APP-DESK) >> TC-APP-DESK-05 Open button navigates to canvas
- Location: e2e/applications-desktop.spec.ts:38:3
