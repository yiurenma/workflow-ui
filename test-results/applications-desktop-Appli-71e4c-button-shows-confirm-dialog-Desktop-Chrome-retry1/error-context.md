...
- Name: applications-desktop.spec.ts >> Applications list — Desktop (TC-APP-DESK) >> TC-APP-DESK-09 Delete button shows confirm dialog
- Location: e2e/applications-desktop.spec.ts:87:3
