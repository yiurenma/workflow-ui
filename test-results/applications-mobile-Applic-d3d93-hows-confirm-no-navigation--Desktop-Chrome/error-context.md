...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-07 ellipsis menu → Delete shows confirm (no navigation)
- Location: e2e/applications-mobile.spec.ts:88:3
