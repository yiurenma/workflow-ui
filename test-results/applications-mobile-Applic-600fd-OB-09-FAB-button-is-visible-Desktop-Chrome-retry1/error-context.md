...
- Name: applications-mobile.spec.ts >> Applications list — Mobile (TC-APP-MOB) >> TC-APP-MOB-09 FAB + button is visible
- Location: e2e/applications-mobile.spec.ts:114:3
