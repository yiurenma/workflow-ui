...
export const IfElsePlugin: React.FC<NodeProps<IfElsePluginProps>> = ({ data, selected }) => (
  <div
    className="flow-node"
    style={{
  ...
  >
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", minWidth: 0 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", minWidth: 0, flex: 1 }}>
        <span style={{ fontSize: 11, fontWeight: 600, lineHeight: 1.25, color: "#161616" }}>Condition</span>
