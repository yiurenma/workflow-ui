import { ConsumerWithoutErrorPluginProps } from "@/types/plugins";
...
export const ConsumerWithoutErrorPlugin: React.FC<NodeProps<ConsumerWithoutErrorPluginProps>> = ({
  ...
  return (
    <div
      ...
      `}
    >
      <div className="w-1 shrink-0 bg-teal-500 rounded-l-xl" />
      ...
      <div className="flex flex-col gap-1 px-3 py-2 flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <span className="flex items-center justify-center w-6 h-6 rounded-md bg-teal-100 text-teal-600 text-sm shrink-0">
            {data.icon}
          </span>
          <span className="text-xs font-semibold text-teal-600 leading-none">Safe Consumer</span>
        </div>
