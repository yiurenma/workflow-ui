  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        ...
        '**/hub-deploy-desktop.spec.ts',
        '**/canvas-import-desktop.spec.ts',
        '**/canvas-import-v39.spec.ts',
        '**/canvas-import-ifelse.spec.ts',
      ],
    },
    {
      name: 'Mobile Chrome',
      ...
      testMatch: [
        ...
        '**/drawer-close-v29.spec.ts',
        '**/hub-deploy-mobile.spec.ts',
        '**/canvas-import-mobile.spec.ts',
      ],
    },
  ],
});
