...
- Name: navigation.spec.ts >> Navigation — TC-NAV >> TC-NAV-01 app loads at root
- Location: e2e/navigation.spec.ts:4:3

# Error details

```
Error: page.goto: net::ERR_INVALID_AUTH_CREDENTIALS at https://workflow-ui-gamma.vercel.app/
Call log:
  - navigating to "https://workflow-ui-gamma.vercel.app/", waiting until "load"
